<?php
	if (isset($_POST['guardar'])){
		...
		$consulta = 'UPDATE administradores SET password= "'.$psw.'" WHERE id_administrador='.$_POST['id'];
// 		 echo $consulta;
		...
		if (!isset($_GET['id'])){
		    ...
		    $query = "SELECT * FROM administradores where activo=1 and id_administrador=".$_GET['id'];
// 		    echo $query;
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Editar Clave Administrador</h2>
						<div class="box-icon">
