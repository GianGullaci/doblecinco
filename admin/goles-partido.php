            ...
            <div class="card">
                ...
                <form  class="p-4" method="POST" action="#" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input class="form-check-input" type="checkbox" value="1" id="contra" name="contra">
                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $opcionesGolesPartido->hora; ?></td>
                                <?php 
                                ...
                                ?>
                                <td style="text-align: center;"><a onclick="return confirm('Estás seguro de eliminar?');" class="text-danger" href="?id_gol=<?php echo $opcionesGolesPartido->id_gol;?>"><i class="bi bi-trash-fill"></i></a></td>
                            </tr>
