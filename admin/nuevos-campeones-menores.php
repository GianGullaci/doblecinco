...
<?php
	if (isset($_POST['nombre_a_mostrar'])){
		...
		$consulta = 'INSERT INTO campeones_menores (clubes_id_club, categorias_id_categoria, torneos_id_torneo, nombre_a_mostrar, zona, texto) 
		VALUES 
							...
							<div class="control-group">
								...
								<div class="controls">
								  <select id="categoria" name="categoria" data-rel="chosen">
									<?php
									    select_categorias_de_padre($mysqli,1);
									?>
								  </select>
								</div>
							  </div>  
