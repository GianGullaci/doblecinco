...
<body>
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Campeones Juveniles</a></li>
			</ul>

			<div class="row-fluid sortable">		
				<div class="box span12">
					<a class="btn btn-primary" type="button" href="nuevos-campeones-menores.php">Agregar Nuevo</a>
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Campeones Juveniles</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable" id="tabla-campeon">
						  ...
						  <tbody>
							...
							<?php
								$query = "SELECT * FROM campeones_menores 
								left join clubes on clubes.id_club=campeones_menores.clubes_id_club
								left join torneos on id_torneo=campeones_menores.torneos_id_torneo
								left join categorias on categorias.id_categoria=campeones_menores.categorias_id_categoria
								...
								while($row = mysqli_fetch_array($result)) {
									...
									<a class='btn btn-info' href='editar-campeones-menores.php?id=".$row['id_campeon']."'>
...
// 		$('a.btn-danger').click(function(e) {
		$( '#tabla-campeon' ).on( 'click', 'a.btn-danger', function(e) {
			...
			if (confirm("Esta seguro que desea eliminar el registro?")){
				...
				$.ajax({
					type: 'get',
					url: 'delete-campeon-menores.php',
