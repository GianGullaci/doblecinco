...
<?php
	...
	if (isset($_POST['nombre_a_mostrar'])){
		...
		$consulta = 'UPDATE campeones_menores SET
		nombre_a_mostrar= "'.$_POST['nombre_a_mostrar'].'",
		zona= "'.$_POST['zona'].'", 
		clubes_id_club= '.$_POST['club'].',
		categorias_id_categoria= '.$_POST['categoria'].',
	...
	$query = "SELECT * FROM campeones_menores where id_campeon=".$_GET['id'] or die("Error in the consult.." . mysqli_error($mysqli));
	...
	if ($row = mysqli_fetch_array($result)) {
		...
		$categoria = $row['categorias_id_categoria'];
	...
	<link href="../editor/sample.css" rel="stylesheet" type="text/css" />
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
					<i class="icon-edit"></i>
					<a href="listado-campeones-menores.php">Campeones Juveniles</a>
				</li>
			</ul>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Editar Campeones Juveniles</h2>
						<div class="box-icon">
							...
							<div class="control-group">
								...
								<div class="controls">
								  <select id="categoria" name="categoria" data-rel="chosen">
									<?php
									    select_categorias_de_padre($mysqli,1,$categoria);
									?>
								  </select>
								</div>
							  </div>  
