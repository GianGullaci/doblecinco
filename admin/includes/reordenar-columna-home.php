<?php include("session.php");
	...
	$nuevo_orden= explode(",",$_GET['orden_columna_home']);
	$i=1;
	$id_anterior_it = 0;
	...
	if ($a_comparar!=0){
		...
		if($row = mysqli_fetch_array($result)) {
			//si la nota anterior esta o no en la columna_home, significa que esta nota tampoco
			$consulta = 'UPDATE notas SET
			columna_home='.$row['columna_home'].' 
			...
			$json = array(
				'modificado' => true,
				'columna_home' => $columna_home,
				'orden_columna_home'=>$posicion
			      );
