...
// 	});
	...
	$('.popcomm').click(function(e){
			e.preventDefault();
		$('#myModal').modal('show');
	});
	
// 	$('.popvercomm').click(function(e){
// 			e.preventDefault();
// 		$('#myModal2').modal('show');
// 	});
