...
.i18.en={translator:"Troex Nevelin &lt;troex@fury.scancode.ru&gt;",language:"English",direction:"ltr",dateFormat:"M d, Y h:i A",fancyDateFormat:"$1 h:i A",messages:{error:"Error",errUnknown:"Unknown error.",errUnknownCmd:"Unknown command.",errJqui:"Invalid jQuery UI configuration. Selectable, draggable and droppable components must be included.",errNode:"elFinder requires DOM Element to be created.",errURL:"Invalid elFinder configuration! URL option is not set.",errAccess:"Access denied.",errConnect:"Unable to connect to backend.",errAbort:"Connection aborted.",errTimeout:"Connection timeout.",errNotFound:"Backend not found.",errResponse:"Invalid backend response.",errConf:"Invalid backend configuration.",errJSON:"PHP JSON module not installed.",errNoVolumes:"Readable volumes not available.",errCmdParams:'Invalid parameters for command "$1".',errDataNotJSON:"Data is not JSON.",errDataEmpty:"Data is empty.",errCmdReq:"Backend request requires command name.",errOpen:'Unable to open "$1".',errNotFolder:"Object is not a folder.",errNotFile:"Object is not a file.",errRead:'Unable to read "$1".',errWrite:'Unable to write into "$1".',errPerm:"Permission denied.",errLocked:'"$1" is locked and can not be renamed, moved or removed.',errExists:'File named "$1" already exists.',errInvName:"Invalid file name.",errFolderNotFound:"Folder not found.",errFileNotFound:"File not found.",errTrgFolderNotFound:'Target folder "$1" not found.',errPopup:"Browser prevented opening popup window. To open file enable it in browser options.",errMkdir:'Unable to create folder "$1".',errMkfile:'Unable to create file "$1".',errRename:'No fue posible renombrar "$1".',errCopyFrom:'Copying files from volume "$1" not allowed.',errCopyTo:'Copying files to volume "$1" not allowed.',errUpload:"Upload error.",errUploadFile:'Unable to upload "$1".',errUploadNoFiles:"No files found for upload.",errUploadTotalSize:"Data exceeds the maximum allowed size.",errUploadFileSize:"El archivo excede el tama&ntilde;o fijado.",errUploadMime:"Tipo de archivo no permitido.",errUploadTransfer:'"$1" transfer error.',errNotReplace:'El objeto "$1" ya existe en esta ubicacion y no puede ser reemplazado.',errReplace:'No fue posible reemplazar "$1".',errSave:'Unable to save "$1".',errCopy:'Unable to copy "$1".',errMove:'No fue posible mover "$1".',errCopyInItself:'Unable to copy "$1" into itself.',errRm:'Unable to remove "$1".',errRmSrc:"Unable remove source file(s).",errExtract:'Unable to extract files from "$1".',errArchive:"Unable to create archive.",errArcType:"Unsupported archive type.",errNoArchive:"File is not archive or has unsupported archive type.",errCmdNoSupport:"Backend does not support this command.",errReplByChild:"The folder “$1” can’t be replaced by an item it contains.",errArcSymlinks:"For security reason denied to unpack archives contains symlinks.",errArcMaxSize:"Archive files exceeds maximum allowed size.",errResize:'Unable to resize "$1".',errUsupportType:"Unsupported file type.",errNotUTF8Content:'File "$1" is not in UTF-8 and cannot be edited.',cmdarchive:"Crear archivo",cmdback:"Atras",cmdcopy:"Copiar",cmdcut:"Cortar",cmddownload:"Descargar",cmdduplicate:"Duplicar",cmdedit:"Editar archivo de texto",cmdextract:"Extraer archivos",cmdforward:"Adelante",cmdgetfile:"Seleccionar archivos",cmdhelp:"About this software",cmdhome:"Home",cmdinfo:"Info",cmdmkdir:"Nueva carpeta",cmdmkfile:"Nuevo archivo de texto",cmdopen:"Abrir",cmdpaste:"Pegar",cmdquicklook:"Previsualizar",cmdreload:"Recargar",cmdrename:"Renombrar",cmdrm:"Eliminar",cmdsearch:"Buscar archivos",cmdup:"Ir al directorio padre",cmdupload:"Subir archivos",cmdview:"Ver",cmdresize:"Redimensionar y Rotar",cmdsort:"Ordenar",btnClose:"Cerrar",btnSave:"Guardar",btnRm:"Eliminar",btnApply:"Aplicar",btnCancel:"Cancelar",btnNo:"No",btnYes:"Si",ntfopen:"Abrir carpeta",ntffile:"Abrir archivo",ntfreload:"Recargar contenido de la carpeta",ntfmkdir:"Creando directorio",ntfmkfile:"Creando archivos",ntfrm:"Eliminar archivos",ntfcopy:"Copiar archivos",ntfmove:"Mover archivos",ntfprepare:"Preparando para copiar",ntfrename:"Renombrar archivos",ntfupload:"Subiendo archivos",ntfdownload:"Descargando archivos",ntfsave:"Guardar archivos",ntfarchive:"Creando archivo",ntfextract:"Extrayendo archivos",ntfsearch:"Buscando archivos",ntfresize:"Redimensionar imagenes",ntfsmth:"Doing something >_<",ntfloadimg:"Cargando imagen",dateUnknown:"unknown",Today:"Hoy",Yesterday:"Ayer",Jan:"Ene",Feb:"Feb",Mar:"Mar",Apr:"Abr",May:"May",Jun:"Jun",Jul:"Jul",Aug:"Ago",Sep:"Sep",Oct:"Oct",Nov:"Nov",Dec:"Dic",sortnameDirsFirst:"por nombre (carpetas primero)",sortkindDirsFirst:"por tipo (carpetas primero)",sortsizeDirsFirst:"por tama&ntilde;o (carpetas primero)",sortdateDirsFirst:"por fecha (carpetas primero)",sortname:"por nombre",sortkind:"por tipo",sortsize:"por tama&ntilde;o",sortdate:"por fecha",confirmReq:"Confirmacion requerida",confirmRm:"Esta seguro que quiere eliminar los archivos?<br/>Esta operacion no puede ser deshecha!",confirmRepl:"Reemplazar el viejo archivo por el nuevo?",apllyAll:"Aplicar a todos",name:"Nombre",size:"Tama&ntilde;o",perms:"Permisos",modify:"Modificado",kind:"Tipo",read:"read",write:"write",noaccess:"no access",and:"y",unknown:"unknown",selectall:"Seleccionar todos los archivos",selectfiles:"Seleccionar archivo(s)",selectffile:"Select first file",selectlfile:"Select last file",viewlist:"Ver lista",viewicons:"Ver iconos",places:"Places",calc:"Calculate",path:"Path",aliasfor:"Alias for",locked:"Locked",dim:"Dimensiones",files:"Archivos",folders:"Carpetas",items:"Items",yes:"si",no:"no",link:"Link",searcresult:"Resultados de busqueda",selected:"items seleccionados",about:"About",shortcuts:"Shortcuts",help:"Help",webfm:"Web file manager",ver:"Version",protocol:"protocol version",homepage:"Project home",docs:"Documentation",github:"Fork us on Github",twitter:"Follow us on twitter",facebook:"Join us on facebook",team:"Team",chiefdev:"chief developer",developer:"developer",contributor:"contributor",maintainer:"maintainer",translator:"translator",icons:"Icons",dontforget:"and don't forget to take your towel",shortcutsof:"Shortcuts disabled",dropFiles:"Drop files here",or:"or",selectForUpload:"Select files to upload",moveFiles:"Move files",copyFiles:"Copy files",rmFromPlaces:"Remove from places",aspectRatio:"Aspect ratio",scale:"Scale",width:"Width",height:"Height",resize:"Resize",crop:"Crop",rotate:"Rotate","rotate-cw":"Rotate 90 degrees CW","rotate-ccw":"Rotate 90 degrees CCW",degree:"°",kindUnknown:"Unknown",kindFolder:"Folder",kindAlias:"Alias",kindAliasBroken:"Broken alias",kindApp:"Application",kindPostscript:"Postscript document",kindMsOffice:"Microsoft Office document",kindMsWord:"Microsoft Word document",kindMsExcel:"Microsoft Excel document",kindMsPP:"Microsoft Powerpoint presentation",kindOO:"Open Office document",kindAppFlash:"Flash application",kindPDF:"Portable Document Format (PDF)",kindTorrent:"Bittorrent file",kind7z:"7z archive",kindTAR:"TAR archive",kindGZIP:"GZIP archive",kindBZIP:"BZIP archive",kindZIP:"ZIP archive",kindRAR:"RAR archive",kindJAR:"Java JAR file",kindTTF:"True Type font",kindOTF:"Open Type font",kindRPM:"RPM package",kindText:"Text document",kindTextPlain:"Plain text",kindPHP:"PHP source",kindCSS:"Cascading style sheet",kindHTML:"HTML document",kindJS:"Javascript source",kindRTF:"Rich Text Format",kindC:"C source",kindCHeader:"C header source",kindCPP:"C++ source",kindCPPHeader:"C++ header source",kindShell:"Unix shell script",kindPython:"Python source",kindJava:"Java source",kindRuby:"Ruby source",kindPerl:"Perl script",kindSQL:"SQL source",kindXML:"XML document",kindAWK:"AWK source",kindCSV:"Comma separated values",kindDOCBOOK:"Docbook XML document",kindImage:"Image",kindBMP:"BMP image",kindJPEG:"JPEG image",kindGIF:"GIF Image",kindPNG:"PNG Image",kindTIFF:"TIFF image",kindTGA:"TGA image",kindPSD:"Adobe Photoshop image",kindXBITMAP:"X bitmap image",kindPXM:"Pixelmator image",kindAudio:"Audio media",kindAudioMPEG:"MPEG audio",kindAudioMPEG4:"MPEG-4 audio",kindAudioMIDI:"MIDI audio",kindAudioOGG:"Ogg Vorbis audio",kindAudioWAV:"WAV audio",AudioPlaylist:"MP3 playlist",kindVideo:"Video media",kindVideoDV:"DV movie",kindVideoMPEG:"MPEG movie",kindVideoMPEG4:"MPEG-4 movie",kindVideoAVI:"AVI movie",kindVideoMOV:"Quick Time movie",kindVideoWM:"Windows Media movie",kindVideoFlash:"Flash movie",kindVideoMKV:"Matroska movie",kindVideoOGG:"Ogg movie"}}),a.fn.elfinderbutton=
