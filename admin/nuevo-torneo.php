<?php
	if (isset($_POST['guardar']) or isset($_POST['guardarf'])){
		...
		$consulta = 'INSERT INTO torneos (nombre_torneo, fecha_inicio, fecha_fin, descripcion) 
		VALUES 
		("'.$_POST['nombre'].'", "'.$fecha.'", "'.$fechafin.'",  "'.base64_encode($txt).'")';
		 //echo $consulta;
		$sentencia = $mysqli->prepare($consulta);
		$sentencia->execute();
		$id = mysqli_insert_id($mysqli);
		if (isset($_POST['guardar'])){
		  header("Location: listado-torneos.php");
		}
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Cargar Torneo</h2>
						<div class="box-icon">
