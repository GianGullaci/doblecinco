...
<?php
	if (isset($_POST['nombre_a_mostrar'])){
		...
		$consulta = 'INSERT INTO campeones_infantiles (clubes_id_club, torneos_id_torneo, nombre_a_mostrar, zona,texto) 
		VALUES 
		('.$_POST['club'].','.$_POST['torneo'].',"'.$_POST['nombre_a_mostrar'].'","'.$_POST['zona'].'","'.base64_encode($txt).'")';
		 //echo $consulta;
