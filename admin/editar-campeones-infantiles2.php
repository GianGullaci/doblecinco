...
<?php
	...
	if (isset($_POST['nombre_a_mostrar'])){
		...
		$consulta = 'UPDATE campeones_infantiles2 SET
	...
	$query = "SELECT * FROM campeones_infantiles2 where id_campeon=".$_GET['id'] or die("Error in the consult.." . mysqli_error($mysqli));
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Editar Campeones Menores</h2>
						<div class="box-icon">
