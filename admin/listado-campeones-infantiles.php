...
<body>
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Campeones Infantiles</a></li>
			</ul>

			<div class="row-fluid sortable">		
				<div class="box span12">
					<a class="btn btn-primary" type="button" href="nuevos-campeones-infantiles.php">Agregar Nuevo</a>
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Campeones Infantiles</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable" id="tabla-campeon">
						  ...
						  <tbody>
							...
							<?php
								$query = "SELECT * FROM campeones_infantiles 
								left join clubes on clubes.id_club=campeones_infantiles.clubes_id_club
								left join torneos on id_torneo=campeones_infantiles.torneos_id_torneo
								...
								while($row = mysqli_fetch_array($result)) {
									...
									<a class='btn btn-info' href='editar-campeones-infantiles.php?id=".$row['id_campeon']."'>
...
// 		$('a.btn-danger').click(function(e) {
		$( '#tabla-campeon' ).on( 'click', 'a.btn-danger', function(e) {
			...
			if (confirm("Esta seguro que desea eliminar el registro?")){
				...
				$.ajax({
					type: 'get',
					url: 'delete-campeon-infantiles.php',
