...
<?php
	...
	if ($row_torneo = mysqli_fetch_array($result)){
		$torneo_menores=$row_torneo['id_torneo_menores'];
		$torneo_infantiles=$row_torneo['id_torneo_infantiles'];
		$torneos=true;
	}
				...
				if (!$started){
					echo '
						...
						<div class="d-flex">  
							...
							<button class="nav-link active" id="v-pills-'.$row_general3['nombre_categoria'].'-tab" data-bs-toggle="pill" data-bs-target="#v-pills-'.$row_general3['nombre_categoria'].'" type="button" role="tab" aria-controls="v-pills-'.$row_general3['nombre_categoria'].'" aria-selected="false">'.$row_general3['nombre_categoria'].'</button>
					';
					...
					echo '<button class="nav-link" id="v-pills-'.$row_general3['nombre_categoria'].'-tab" data-bs-toggle="pill" data-bs-target="#v-pills-'.$row_general3['nombre_categoria'].'" type="button" role="tab" aria-controls="v-pills-'.$row_general3['nombre_categoria'].'" aria-selected="false">'.$row_general3['nombre_categoria'].'</button>';
				}
				$started=true;
			}
			...
			while($row_general3 = mysqli_fetch_array($result_general3)) {
				...
				if (!$started){
					echo '
								...
								<div class="tab-pane fade show active" id="v-pills-'.$row_general3['nombre_categoria'].'" role="tabpanel" aria-labelledby="v-pills-'.$row_general3['nombre_categoria'].'-tab">
								<h3 data-tab="goleadores-'.$row_general3['nombre_categoria'].'" class="v_nav v_active ">'.$row_general3['nombre_categoria'].'</h3>
							';
				}
				else{
					echo '<div class="tab-pane fade" id="v-pills-'.$row_general3['nombre_categoria'].'" role="tabpanel" aria-labelledby="v-pills-'.$row_general3['nombre_categoria'].'-tab">
