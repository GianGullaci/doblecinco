...
while($row_general2 = mysqli_fetch_array($result_general2)) {
    ...
    font-size: 18px;">Campeonato Juveniles y Menores</div></h2>';
			...
			echo '<h3 class="mostrarocultar-posiciones"  onclick="'.$funcion.'"><span>+</span>&nbsp;&nbsp;&nbsp;Menores. Fase 2: Clausura.</h3>';
		}
		echo '
...
if ($started_cascara){
	...
	$leyenda="General corresponde a la suma de Octava, Novena, Décima y Predecima";
