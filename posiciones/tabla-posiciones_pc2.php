...
// 	$query_resultado = 
		$query_resultado = 
			"select id_torneo, ".$select_equipos." todos1.clubes_id_club, todos1.logo_club, todos1.categorias_id_categoria, 
		      ...
		      left join sanciones_equipos_torneo as sancion on (sancion.sanciones_id_torneo=resul_local.id_torneo and sancion.sanciones_id_club = clubes_id_club and sancion.sanciones_id_categoria = categorias_id_categoria and sancion.sanciones_id_fase = resul_local.fase and sancion.sanciones_id_equipo = id_equipo and sancion.sanciones_id_equipo = id_equipo)
			...
			foreach ($arreglo_renglones as $renglon){
				...
				if ($general or $id_padre<>0){
					...
					echo 		'</td>
							...
							<td>'.$renglon['diferencia_de_goles'].'</td>
						</tr>
...
// 			    $sort['total_puntos'][$k] = $v['total_puntos'];
			...
			array_multisort($sort['total_puntos_con_sansion'], SORT_DESC, $sort['ganados'], SORT_DESC, $sort['diferencia_de_goles'], SORT_ASC,$sort['goles_favor'], SORT_DESC, $arreglo_renglones);
