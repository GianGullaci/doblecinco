...
while($row_general2 = mysqli_fetch_array($result_general2)) {
    ...
    font-size: 18px;">Campeonato Juveniles y Menores </div></h2>';
			...
			echo '<h3 class="mostrarocultar-posiciones"  onclick="'.$funcion.'"><span>+</span>&nbsp;&nbsp;&nbsp;Posiciones Fase 2 Juveniles</h3>';
		}
		echo '
...
while($row_general2 = mysqli_fetch_array($result_general2)) {
	...
	echo '<div class="tab_content" id="'.$fase.'-posiciones-'.$row_general2['nombre_categoria'].'">FASE2-MENORES2';
		include("posiciones/panel-posiciones2.php");
	echo '</div>';
